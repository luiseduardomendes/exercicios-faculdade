...
st.markdown('This aplication is a Streamlit dashboard '
'that can be used to analyse motor vehicle '
...
st.header('How many collision occur during a given time of a day?')
hour = st.slider('Hour to look at', 0, 23)
data = data[data['date/time'].dt.hour == hour]

st.markdown(f'Vehicle collision between {hour%24}:00 and {(hour+1)%24}:00')
