...
class Maze():
    def __init__(self, filename):
        ...
        # check if theres a begin and a goal
        if contents.count('A') == 0:
            raise Exception("Maze must have at least a begin")
        if contents.count('B') == 0:
            raise Exception("Maze must have at least a goal")
        ...
        # makes a boolean matrix to the walls
        self.walls = []
